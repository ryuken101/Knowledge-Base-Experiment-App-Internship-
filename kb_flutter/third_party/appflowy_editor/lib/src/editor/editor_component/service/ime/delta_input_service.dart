...
class DeltaTextInputService extends TextInputService with DeltaTextInputClient {
  ...
  // LOCAL PATCH (kb_flutter): Flutter 3.44 added TextInputClient.onFocusReceived.
  // DeltaTextInputClient re-abstracts TextInputClient via `implements`, so this
  // must be provided concretely or the package fails to build. Remove once a
  // published appflowy_editor implements it. See third_party/appflowy_editor.
  @override
